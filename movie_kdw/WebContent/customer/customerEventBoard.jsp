...
<table border="1" class="movieTable2">
	<tr>
		<td colspan="6" class="tt" width="500px">
		<font size="5">이벤트 게시판</font>
		</td>
	</tr>
	<tr>
		<th class="tt">번호</th>
	...
	<%
		for(int i=0;i<list.size();i++){
			...
			<td align="left">
			<a href="customerEvent.jsp?boardNum=<%=ebean.getBoardNum()%>&pageNum=<%=pageNum %>" style="text-decoration: none; color: #013C4D"><%=ebean.getBoardTitle() %></a>
				<%
