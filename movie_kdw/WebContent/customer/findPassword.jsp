...
<script type="text/javascript">
	function checkCon() {
		...
		if (document.myform.ssn1.value == "") {
			document.myform.ssn1.focus()
			alert("주민등록번호를 입력하세요");
			return false;
		}
		if (document.myform.ssn2.value == "") {
			document.myform.ssn2.focus()
			alert("주민등록번호를 입력하세요");
			return false;
		}
...
<form method="post" action="findPasswordProc.jsp" name="myform">
